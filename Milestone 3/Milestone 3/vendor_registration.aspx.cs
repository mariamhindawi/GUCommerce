...
namespace Milestone_3
{
    public partial class vendor_registration : System.Web.UI.Page
    {
        ...
        protected void register_Click(object sender, EventArgs e)
        {
            ...
            string company_name_input = company_name.Text;
            string bank_acc_no_input = bank_acc_no.Text;
            ...
            cmd.Parameters.Add(new SqlParameter("@company_name", company_name_input));
            cmd.Parameters.Add(new SqlParameter("@bank_acc_no", bank_acc_no_input));
            ...
            if (username_input == "" || password_input == "" || first_name_input == "" || last_name_input == "" || email_input == "" || company_name_input == "" || bank_acc_no_input == "")
            {
